...
import { Plus, Search, Star, MoreHorizontal, Trash2, Edit2, Archive } from "lucide-react";
...
import { getProjects, createProject, deleteProject, toggleStarProject, updateProject } from "@/lib/api";
  ...
  return (
    <div className="flex-1 overflow-auto p-8" data-testid="projects-page">
      ...
      <Dialog open={!!editingProject} onOpenChange={() => setEditingProject(null)}>
        <DialogContent data-testid="edit-project-dialog" aria-describedby="edit-project-description">
          <DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveEdit} data-testid="save-project-edit">
              Save
            </Button>
          </DialogFooter>
        </DialogContent>
